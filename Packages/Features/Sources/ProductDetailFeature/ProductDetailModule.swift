...
/// Registers the ProductDetail feature. `ProductsServicing` (`Networking`) and
/// `FavoritesStoring` (`Domain`) are both resolved, never constructed here — they're
/// owned by `ProductsModule`/`FavoritesModule` respectively.
